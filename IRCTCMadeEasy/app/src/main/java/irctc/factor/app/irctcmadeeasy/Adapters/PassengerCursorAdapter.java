...
public class PassengerCursorAdapter extends RecyclerViewCursorAdapter<PassengerCursorAdapter.PassengerViewHolder> {
    ...
    static class PassengerViewHolder extends RecyclerViewCursorViewHolder{
        ...
        public void bindCursor(Cursor cursor) {
            ...
            String sText1 = "<b>Gender:</b>" + passengerGender + ", <b>Age:</b> " + passengerAge;
            String sName=passengerName;
            String sText2 = "<b>Berth: </b>" + passengerBerth + "; <b>Food:</b> " + (passengerFood.equals("NonVeg")? "NonVeg" : "Veg");

            // Populate fields with extracted properties
            txtView1.setText(sName);
            txtView2.setText(Html.fromHtml(sText1));
            txtView3.setText(Html.fromHtml(sText2));
